...
class SettingsManager private constructor(private val context: Context) {
    companion object {
        ...
        private const val KEY_AIMACRODROID_BASE_URL = "aimacrodroid_base_url"
        private const val KEY_AIMACRODROID_SECRET_KEY = "aimacrodroid_secret_key"
    }
    ...
    /**
     * Gets the AiMacrodroid Base URL.
     */
    fun getAiMacrodroidBaseUrl(): String {
        return prefs.getString(KEY_AIMACRODROID_BASE_URL, "") ?: ""
    }

    /**
     * Sets the AiMacrodroid Base URL.
     */
    fun setAiMacrodroidBaseUrl(url: String) {
        prefs.edit().putString(KEY_AIMACRODROID_BASE_URL, url).apply()
    }

    /**
     * Gets the AiMacrodroid Secret Key.
     */
    fun getAiMacrodroidSecretKey(): String {
        return prefs.getString(KEY_AIMACRODROID_SECRET_KEY, "") ?: ""
    }

    /**
     * Sets the AiMacrodroid Secret Key.
     */
    fun setAiMacrodroidSecretKey(key: String) {
        prefs.edit().putString(KEY_AIMACRODROID_SECRET_KEY, key).apply()
    }
